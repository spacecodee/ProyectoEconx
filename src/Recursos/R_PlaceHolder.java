...
public class R_PlaceHolder extends JLabel implements FocusListener, DocumentListener {
    ...
    public R_PlaceHolder(String text, JTextComponent component) {
        this(text, component, Show.ALWAYS);
    }

    public R_PlaceHolder(String text, JTextComponent component, Show show) {

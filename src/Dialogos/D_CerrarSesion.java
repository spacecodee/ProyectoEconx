...
public class D_CerrarSesion extends javax.swing.JDialog {
    ...
    public D_CerrarSesion(V_Menu vMenu, boolean modal) {
        super(vMenu, modal);
        this.vMenu = vMenu;
        ini();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¿ESTAS SEGURO(A) QUE DESEAS CERRAR SESIÓN?");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(20, 180, 760, 60);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(D_CerrarSesion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_CerrarSesion dialog = new D_CerrarSesion(new V_Menu(), true);

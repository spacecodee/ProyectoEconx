...
public class D_EliminarConfirmar extends javax.swing.JDialog {
    ...
    public D_EliminarConfirmar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ini();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(D_EliminarConfirmar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_EliminarConfirmar dialog = new D_EliminarConfirmar(new java.awt.Frame(), true);

...
public class V_EditarUsuario extends javax.swing.JDialog {

    C_Usuario cUsuario = new C_Usuario();
    C_Menu cMenu = new C_Menu();
    public int id;

    public V_EditarUsuario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ini();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(cbxRoll);
        cbxRoll.setBounds(640, 310, 370, 50);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (evt.getSource() == btnSave) {
            if (cUsuario.actualizar(cbxRoll, txtDNI, txtNom, txtApe, txtTelefono, id)) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                V_EditarUsuario dialog = new V_EditarUsuario(new javax.swing.JFrame(), true);
    ...
    public static rojerusan.RSComboBox cbxRoll;
    ...
    private void ini() {
        ...
        cUsuario.fantasmaText(txtDNI, txtNom, txtApe, txtTelefono);

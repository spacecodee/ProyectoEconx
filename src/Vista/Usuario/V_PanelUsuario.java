...
public class V_PanelUsuario extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "DNI", "NOMBRE", "APELLIDOS", "TELÉFONO", "ROLL"
            }
        ) {
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        if (evt.getSource() == txtBuscar) {
            cUsuario.buscarTablaUsuario(tblUsuarios, txtBuscar);
        }
    }//GEN-LAST:event_txtBuscarKeyReleased

    private void txtBuscarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyTyped
        if (evt.getSource() == txtBuscar) {
            cUsuario.verif(evt, txtBuscar);
        }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (evt.getSource() == btnEditar) {
            if (!cDialogos.validarSeleccion(tblUsuarios, "Selecciona lo que deseas editar")) {
                cUsuario.pasarUsuario(tblUsuarios);
                cUsuario.mostrarTablaUsuario(tblUsuarios);
            }
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (evt.getSource() == btnEliminar) {
            if (!cDialogos.validarSeleccion(tblUsuarios, "Selecciona lo que deseas eliminar")) {
                cUsuario.dialogoEliminarUsuario(id, tblUsuarios, "¿Estas seguro que deseas eliminar el registro?");
            }
        }
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        if (evt.getSource() == btnAgregar) {
            cUsuario.dialogoAgregarUsuario();
            cUsuario.mostrarTablaUsuario(tblUsuarios);
        }
    ...
    private void ini() {
        ...
        cUsuario.agregarImg(btnAgregar, btnEditar, btnEliminar);
        cUsuario.fantasmaText(txtBuscar, "Buscar por dni");
    }
}

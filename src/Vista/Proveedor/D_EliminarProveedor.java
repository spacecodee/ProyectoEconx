...
public class D_EliminarProveedor extends javax.swing.JDialog {
    ...
    public D_EliminarProveedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ini();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(D_EliminarProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_EliminarProveedor dialog = new D_EliminarProveedor(new java.awt.Frame(), true);

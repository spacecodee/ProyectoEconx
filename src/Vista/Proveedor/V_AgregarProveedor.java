...
public class V_AgregarProveedor extends javax.swing.JDialog {
    ...
    public V_AgregarProveedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ini();
    }
        ...
        if (evt.getSource() == btnSave) {
            if (!cProveedor.textVacio(txtDNI, txtNom, txtApe, txtCorreo, txtTelefono, lblMensaje)) {
                if (!cProveedor.correo(txtCorreo, lblMensaje)) {
                    if (cProveedor.agregar(txtDNI, txtNom, txtApe, txtCorreo, txtTelefono)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_AgregarProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                V_AgregarProveedor dialog = new V_AgregarProveedor(new javax.swing.JFrame(), true);

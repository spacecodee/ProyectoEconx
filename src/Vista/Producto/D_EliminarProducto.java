...
public class D_EliminarProducto extends javax.swing.JDialog {
    ...
    public D_EliminarProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ini();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(D_EliminarProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_EliminarProducto dialog = new D_EliminarProducto(new java.awt.Frame(), true);

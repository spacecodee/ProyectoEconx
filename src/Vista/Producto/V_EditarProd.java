...
public class V_EditarProd extends javax.swing.JDialog {
    ...
    public V_EditarProd(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ini();
    }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (evt.getSource() == btnSave) {
            if (!cProducto.textVacio(txtCodigo, txtNom, txtPrecio, txtStock, lblMensaje)) {
                cProducto.actualizar(id, txtCodigo, txtNom, txtPrecio, txtStock, cbxCategoria);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_EditarProd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                V_EditarProd dialog = new V_EditarProd(new javax.swing.JFrame(), true);
    ...
    public static rojerusan.RSComboBox cbxCategoria;

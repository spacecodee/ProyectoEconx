...
public class D_EliminarRoll extends javax.swing.JDialog {
    ...
    public D_EliminarRoll(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ini();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(D_EliminarRoll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_EliminarRoll dialog = new D_EliminarRoll(new java.awt.Frame(), true);

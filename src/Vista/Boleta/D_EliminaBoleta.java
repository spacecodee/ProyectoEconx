...
public class D_EliminaBoleta extends javax.swing.JDialog {
    ...
    public D_EliminaBoleta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ini();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(D_EliminaBoleta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_EliminaBoleta dialog = new D_EliminaBoleta(new java.awt.Frame(), true);

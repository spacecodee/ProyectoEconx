...
public class V_EditarBol extends javax.swing.JDialog {

    C_Boleta cBoleta = new C_Boleta();
    public int id;

    public V_EditarBol(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ini();
    }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (evt.getSource() == btnSave) {
            if (!cBoleta.textVacio(cbxTrae, cbxComprador, txtCodigo, txtPrecio, txtStock, txtEmpres, lblMensaje)) {
                //cBoleta.actualizar(cbxTrae, cbxComprador, txtCodigo, txtPrecio, txtStock, txtEmpres, id);
                this.dispose();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_EditarBol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                V_EditarBol dialog = new V_EditarBol(new javax.swing.JFrame(), true);

...
public class V_AgregarBolRe extends javax.swing.JDialog {
    ...
    public V_AgregarBolRe(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ini();
    }
    ...
    private void initComponents() {
        ...
        pnlContenedor.setMaximumSize(new java.awt.Dimension(1100, 580));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (evt.getSource() == btnSave) {
            cBoleta.agregar(idT, cbxComprador, txtCodigo, txtEmpresa, dtFecha);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_AgregarBolRe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                V_AgregarBolRe dialog = new V_AgregarBolRe(new javax.swing.JFrame(), true);

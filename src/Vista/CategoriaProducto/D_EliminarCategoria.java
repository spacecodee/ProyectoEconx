...
public class D_EliminarCategoria extends javax.swing.JDialog {

    //Objetos
    C_Dialogos cDialogos = new C_Dialogos();
    C_CategoriaProducto cCategoriaP = new C_CategoriaProducto();
    
    //Variables
    V_Menu vMenu;
    public int id;

    public D_EliminarCategoria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ini();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(D_EliminarCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_EliminarCategoria dialog = new D_EliminarCategoria(new java.awt.Frame(), true);

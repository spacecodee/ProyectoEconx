...
public class V_PanelIntermedia extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblTrae.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "PROVEEDOR", "PRODUCTO", "PRECIO", "STOCK"
            }
        ) {
        ...
        jSeparator1.setBounds(690, 340, 370, 10);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(600, 290, 70, 50);
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Producto/Proce.png"))); // NOI18N
        jPanel1.add(jLabel3);
        jLabel3.setBounds(600, 380, 70, 50);
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(600, 200, 70, 50);
        ...
        cbxProveedor.setBounds(690, 200, 370, 50);
        ...
        txtPrecio.setSelectionColor(new java.awt.Color(73, 131, 254));
        ...
        txtPrecio.setBounds(690, 380, 370, 50);

        jSeparator6.setBackground(new java.awt.Color(73, 131, 254));
        jSeparator6.setForeground(new java.awt.Color(73, 131, 254));
        jPanel1.add(jSeparator6);
        jSeparator6.setBounds(690, 430, 370, 10);

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Producto/Stock.png"))); // NOI18N
        jPanel1.add(jLabel6);
        jLabel6.setBounds(600, 470, 70, 50);

        jSeparator7.setBackground(new java.awt.Color(73, 131, 254));
        jSeparator7.setForeground(new java.awt.Color(73, 131, 254));
        jPanel1.add(jSeparator7);
        jSeparator7.setBounds(690, 520, 370, 10);

        txtStock.setBackground(new java.awt.Color(253, 253, 254));
        ...
        txtStock.setSelectionColor(new java.awt.Color(73, 131, 254));
        ...
        txtStock.setBounds(690, 470, 370, 50);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if (evt.getSource() == btnSave) {
            if (!cTreaProducto.textVacio(txtCodigo, cbxProveedor, cbxProducto, lblMensaje, txtPrecio, txtStock)) {
                if (verificar.equals("Actualizar")) {
                    cTreaProducto.actualizar(txtCodigo, cbxProveedor, cbxProducto, id, txtPrecio, txtStock);
                } else if (verificar.equals("Agregar")) {
                    cTreaProducto.agregar(txtCodigo, cbxProveedor, cbxProducto, txtPrecio, txtStock);
                }
            }
            verificar = "Agregar";
        }
    ...
    private void txtPrecioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPrecioKeyTyped
        if (evt.getSource() == txtPrecio) {
            cTreaProducto.verificar(evt, txtPrecio, lblMensaje);
        }
    }//GEN-LAST:event_txtPrecioKeyTyped

    private void txtStockKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtStockKeyTyped
        if (evt.getSource() == txtStock) {
            cTreaProducto.verificar(evt, txtStock, lblMensaje);
        }
    ...
    private void ini() {
        ...
        cTreaProducto.fantasmaText(txtBuscar, txtCodigo, txtPrecio, txtStock);
